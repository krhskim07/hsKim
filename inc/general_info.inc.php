...
<div class="general_info d-flex flex-xl-column flex-md-row flex-column">
    ...
    <div class="general_info_content">
        ...
        <div class="general_info_title">Information Générale</div>
        <ul class="general_info_list">
            ...
            <div class="general_info_text">Nom: <span>Hyunsuk KIM</span></div>
            </li>
            <li class="d-flex flex-row align-items-center justify-content-start">
        ...
        <div class="social_container">
            ...
            <li><a href="https://www.linkedin.com/in/hyunsuk-kim/"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
            <li><a href="https://github.com/krhskim07"><i class="fa fa-github" aria-hidden="true"></i></a></li>
            <li><a href="https://www.instagram.com/sugikim07/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
            </ul>
        </div>
        </div>
    </div>
